...
export default function Navbar({ timer, time, onPress,hideBack }: NavbarProps) {
  ...
  { !hideBack &&    <svg onClick={()=>router.back()} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-arrow-left cursor-pointer" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
      ...
      <div className="flex space-x-4 items-center">
        ...
        <button className="text-white border rounded-md px-2 " type="submit">
        <Link
              href={{
                pathname: '/quiz', 
              }}
   ...
   <button className="text-white  border   px-2 rounded-md" type="submit">
        <Link
              href={{
                pathname: '/register', 
              }}
